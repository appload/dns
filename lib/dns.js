(function() {
  ...
  Response = (function() {
    ...
    function Response(name, type, zone, zones) {
      this.type = type;
      this.zone = zone;
      this.zones = zones;
    ...
    Response.prototype.add_additionals = function() {
      var record, zone, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
            zone = _ref2[_j];
            _results2.push(this.add_additional(zone.find("A", record.value)));
          }
          return _results2;
        }).call(this));
      }
    ...
    DNS.prototype.resolve = function(req, res) {
      ...
      if (req.q.length > 0) {
        ...
        if (zone = _.find(this.zones, (function(zone) {
          ...
          response = new Response(name, type, zone, this.zones);
